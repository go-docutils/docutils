...
func TestInline(t *testing.T) {
	cases := []struct {
		...
		{"named auto-numbered footnote reference", "see [#note]_ here", "see \n<footnote_reference auto=\"1\" id=\"footnote-reference-1\" refname=\"note\">\n here\n"},
