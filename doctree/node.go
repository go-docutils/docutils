...
const (
	...
	// TagPending is docutils' placeholder for a directive whose real work
	// happens in a later TRANSFORM (".. class::", ".. sectnum::",
	// ".. target-notes::"). This package has no transform system; the node
	// records what the transform WOULD do, which is all a parse tree holds.
	TagPending           = "pending"
	TagDocinfo           = "docinfo"
	TagAuthor            = "author"
	TagAuthors           = "authors"
